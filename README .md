...
![Customer Behavior Dashboard](dashboard-preview.png)

> *Interactive filters: Subscription · Gender · Category · Shipping Type*  
> *KPIs: Avg Purchase ($59.76) · Avg Rating (3.75) · Total Customers (3.9K)*
...
- 📧 Subscription vs non-subscription revenue (27% Yes vs 73% No)
- 🎂 Age group revenue & sales distribution
...
- 🛍️ **Clothing** leads in both revenue (104K) and total sales (3.4M)
- 👶 **Young Adults** contribute the highest revenue across all age groups
- 📊 Only **27% of customers** are subscribers — a key growth opportunity
